...
[![HackerRank](https://img.shields.io/badge/HackerRank-Profile-blue?style=social&logo=hackerrank)](https://www.hackerrank.com/saurabhjojare)
[![Portfolio](https://img.shields.io/badge/Portfolio-Visit-brightgreen)](http://saurabhjojare.github.io)
[![QuizConnect](https://img.shields.io/badge/QuizConnect-Visit-blue)](https://bytebridgegroup.tech/)
...
- **Technical Skills**: Java (Core, Servlet/JSP, JDBC, Spring/Spring Boot, Hibernate), C/C++, HTML, CSS (Bootstrap), JavaScript (React.js), MySQL(PL/SQL), XML/JSON, REST API
